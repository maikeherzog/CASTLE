...
attribute_properties = {
    "adult":{
        ...
        1: {'name': 'workclass', 'type': 'categorical', 'hierarchy_tree': workclass_tree},
        2: {'name': 'fnlwgt', 'type': 'continuous', 'interval': (13769,  1484705)},
        3: {'name': 'education', 'type': 'categorical', 'hierarchy_tree': education_tree},
        4: {'name': 'education_num', 'type': 'continuous', 'interval': (1, 16)},
        5: {'name': 'marital-status', 'type': 'categorical', 'hierarchy_tree': marital_status_tree},
        6: {'name': 'occupation', 'type': 'categorical', 'hierarchy_tree': occupation_tree},
        7: {'name': 'relationship', 'type': 'categorical', 'hierarchy_tree': relationship_tree},
        8: {'name': 'race', 'type': 'categorical', 'hierarchy_tree': race_tree},
        9: {'name': 'sex', 'type': 'categorical', 'hierarchy_tree': sex_tree},
        ...
        13: {'name': 'native-country', 'type': 'categorical', 'hierarchy_tree': native_country_tree},
        14: {'name': 'income', 'type': 'class', 'attributes': [' <=50K', ' >50K']},
    },
    "easy_data":{
        0: {'name': 'age', 'type': 'continuous', 'interval': (18, 120)},
        1: {'name': 'education', 'type': 'categorical', 'hierarchy_tree': education_tree_easy}
    },
    "adult_castle":{
        0: {'name': 'age', 'type': 'continuous', 'interval': (17, 90)},
        ...
        6: {'name': 'education', 'type': 'categorical', 'hierarchy_tree': education_tree},
        7: {'name': 'marital-status', 'type': 'categorical', 'hierarchy_tree': marital_status_tree},
        8: {'name': 'occupation', 'type': 'categorical', 'hierarchy_tree': occupation_tree},
        9: {'name': 'native-country', 'type': 'categorical', 'hierarchy_tree': native_country_tree},
        10: {'name': 'workclass', 'type': 'categorical', 'hierarchy_tree': workclass_tree},
        11: {'name': 'relationship', 'type': 'categorical', 'hierarchy_tree': relationship_tree},
        12: {'name': 'race', 'type': 'categorical', 'hierarchy_tree': race_tree},
        13: {'name': 'sex', 'type': 'categorical', 'hierarchy_tree': sex_tree},
        14: {'name': 'income', 'type': 'class', 'attributes': [' <=50K', ' >50K']},
    },
    "adult_castle_reverse":{
        0: {'name': 'native-country', 'type': 'categorical', 'hierarchy_tree': native_country_tree},
        1: {'name': 'occupation', 'type': 'categorical', 'hierarchy_tree': occupation_tree},
        2: {'name': 'marital-status', 'type': 'categorical', 'hierarchy_tree': marital_status_tree},
        3: {'name': 'education', 'type': 'categorical', 'hierarchy_tree': education_tree},
    ...
    "adult_castle_mix":{
        0: {'name': 'age', 'type': 'continuous', 'interval': (17, 90)},
        1: {'name': 'native-country', 'type': 'categorical', 'hierarchy_tree': native_country_tree},
        2: {'name': 'fnlwgt', 'type': 'continuous', 'interval': (13769, 1484705)},
        3: {'name': 'occupation', 'type': 'categorical', 'hierarchy_tree': occupation_tree},
        4: {'name': 'education_num', 'type': 'continuous', 'interval': (1, 16)},
        5: {'name': 'marital-status', 'type': 'categorical', 'hierarchy_tree': marital_status_tree},
        6: {'name': 'capital-gain', 'type': 'continuous', 'interval': (0, 99999)},
        7: {'name': 'education', 'type': 'categorical', 'hierarchy_tree': education_tree},
    ...
    "adult_castle_binary_tree":{
            ...
            4: {'name': 'capital-loss', 'type': 'continuous', 'interval': (0, 4356)},
            5: {'name': 'hours-per-week', 'type': 'continuous', 'interval': (1, 99)},
            6: {'name': 'education', 'type': 'categorical', 'hierarchy_tree': education_tree_binary},
            7: {'name': 'marital-status', 'type': 'categorical', 'hierarchy_tree': marital_status_tree_binary},
            8: {'name': 'occupation', 'type': 'categorical', 'hierarchy_tree': occupation_tree_binary},
            9: {'name': 'native-country', 'type': 'categorical', 'hierarchy_tree': native_country_tree_binary},
            10: {'name': 'workclass', 'type': 'categorical', 'hierarchy_tree': workclass_tree_binary},
            11: {'name': 'relationship', 'type': 'categorical', 'hierarchy_tree': relationship_tree_binary},
            12: {'name': 'race', 'type': 'categorical', 'hierarchy_tree': race_tree_binary},
            13: {'name': 'sex', 'type': 'categorical', 'hierarchy_tree': sex_tree},
            14: {'name': 'income', 'type': 'class', 'attributes': [' <=50K', ' >50K']},
    ...
    "adult_castle_binary_tree_short":{
            ...
            7: {'name': 'marital-status', 'type': 'categorical', 'hierarchy_tree': marital_status_tree_binary},
            8: {'name': 'occupation', 'type': 'categorical', 'hierarchy_tree': occupation_tree_binary},
            9: {'name': 'native-country', 'type': 'categorical', 'hierarchy_tree': native_country_tree_binary_short},
            10: {'name': 'workclass', 'type': 'categorical', 'hierarchy_tree': workclass_tree_binary_short},
            11: {'name': 'relationship', 'type': 'categorical', 'hierarchy_tree': relationship_tree_binary},
            12: {'name': 'race', 'type': 'categorical', 'hierarchy_tree': race_tree_binary},
            13: {'name': 'sex', 'type': 'categorical', 'hierarchy_tree': sex_tree},
            14: {'name': 'income', 'type': 'class', 'attributes': [' <=50K', ' >50K']},
